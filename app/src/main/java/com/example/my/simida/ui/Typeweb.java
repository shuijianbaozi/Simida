...
public class Typeweb extends AppCompatActivity {

    private static final String TAG = "type_url";
    @BindView(R.id.wb_typeweb)
    WebView webView;
    @BindView(R.id.activity_typeweb)
    RelativeLayout activityTypeweb;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_typeweb);
        ButterKnife.bind(this);
        Intent intent = getIntent();
        String stringExtra = intent.getStringExtra(ConstantString.CATE_Name);
        String weburl = UrlConfig.TYPEWEB_BASEURL + stringExtra;
