...
public class TypetopwebActivity extends AppCompatActivity {

    private static final String TAG = "webtopviewurl";
    @BindView(R.id.wb_typewebtop)
    WebView webView;
    @BindView(R.id.activity_typetopweb)
    RelativeLayout activityTypetopweb;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_typetopweb);
        ButterKnife.bind(this);
        Intent intent = getIntent();
        String stringExtra = intent.getStringExtra(ConstantString.Search_Name);
        String weburl = UrlConfig.TYPEWEB_BASE + stringExtra;
