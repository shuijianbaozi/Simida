...
public class YifaFragment extends Fragment implements IOnNvshenRvClick{

    @BindView(R.id.rv_yifa)
    RecyclerView rvYifa;
    ...
    public static YifaFragment newInstance() {
        YifaFragment fragment = new YifaFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_yifa, container, false);
    ...
    private void initNvRc() {
        mAdapter = new NvshenRvAdapter(mContext, mRankings, this, "yifa");
        rvYifa.setAdapter(mAdapter);
        LinearLayoutManager manager = new LinearLayoutManager(mContext, OrientationHelper.VERTICAL, false);
        rvYifa.setLayoutManager(manager);
    }
    @Override
