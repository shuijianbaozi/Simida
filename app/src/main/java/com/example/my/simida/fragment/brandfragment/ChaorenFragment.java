 ...
 */
public class ChaorenFragment extends Fragment implements IOnNvshenRvClick{


    @BindView(R.id.rv_chaoren)
    RecyclerView rvChaoren;
    private Context mContext;
    NvshenRvAdapter mAdapter = null;
    List<RankingBean> mRankings = new ArrayList<>();

    // TODO: Rename and change types and number of parameters
    public static ChaorenFragment newInstance() {
        ChaorenFragment fragment = new ChaorenFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chaoren, container, false);
    ...
    private void initNvRc() {
        mAdapter = new NvshenRvAdapter(mContext, mRankings, this, "chaoren");
        rvChaoren.setAdapter(mAdapter);
        LinearLayoutManager manager = new LinearLayoutManager(mContext, OrientationHelper.VERTICAL, false);
        rvChaoren.setLayoutManager(manager);
    }
